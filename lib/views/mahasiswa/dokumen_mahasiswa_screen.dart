import 'package:digita_mobile/widgets/card/uploaded_document_card.dart';
import 'package:digita_mobile/widgets/card/uploaded_yet_document_card.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Subtitle(subtitle: 'Sudah Upload'),
                ),
                ListView.builder(
                ...
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 16.0),
                  child: Subtitle(subtitle: 'Belum Upload'),
                ),
                ListView.builder(
                  physics: const NeverScrollableScrollPhysics(),
                  shrinkWrap: true,
