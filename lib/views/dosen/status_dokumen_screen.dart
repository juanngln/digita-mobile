...
class StatusDokumenScreen extends StatefulWidget {
  final Mahasiswa mahasiswa;

  const StatusDokumenScreen({super.key, required this.mahasiswa});

  @override
  State<StatusDokumenScreen> createState() => _StatusDokumenScreen();
}

class _StatusDokumenScreen extends State<StatusDokumenScreen>
