import 'package:digita_mobile/presentation/common_widgets/home_widgets/notification_card.dart';
import 'package:flutter/material.dart';

class NotificationDosenScreen extends StatefulWidget {
  const NotificationDosenScreen({super.key});

  @override
  State<NotificationDosenScreen> createState() => _NotificationDosenScreenState();
}

class _NotificationDosenScreenState extends State<NotificationDosenScreen> {
